...
If no unverified findings remain (and no work_item was provided), output exactly `SCAN_COMPLETE` and stop. Do nothing else. Never mention this stop word anywhere else in your output.
