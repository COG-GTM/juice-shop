describe('/#/login', () => {
  ...
  describe('SQL injection on login is prevented', () => {
    it('should reject SQLI attack on email field using "\' or 1=1--"', () => {
    ...
    it('should reject SQLI attack on email field using "admin@<juice-sh.op>\'--"', () => {
    ...
    it('should reject SQLI attack on email field using "jim@<juice-sh.op>\'--"', () => {
      cy.task<string>('GetFromConfig', 'application.domain').then(
        (appDomain: string) => {
    ...
    it('should reject SQLI attack on email field using "bender@<juice-sh.op>\'--"', () => {
      cy.task<string>('GetFromConfig', 'application.domain').then(
        (appDomain: string) => {
  ...
  describe('login of deleted user via SQL injection is prevented', () => {
    it('should reject SQLI attack on email field using "\' or deletedAt IS NOT NULL --"', () => {
    ...
    it('should reject SQLI attack on email field using "chris.pike@juice-sh.op\' --"', () => {
      cy.task<string>('GetFromConfig', 'application.domain').then(
        (appDomain: string) => {
  ...
  describe('login via UNION SELECT injection is prevented', () => {
    it('should reject SQLI attack on email field using UNION SELECT payload', () => {
      cy.get('#email').type(
