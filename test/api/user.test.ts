...
void describe('/api/Users', () => {
  ...
  void it('POST new user with admin role is downgraded to customer', async () => {
    const res = await request(app)
      .post('/api/Users')
      .set(jsonHeader)
      .send({
  ...
  void it('POST new user with deluxe role is downgraded to customer', async () => {
    const res = await request(app)
      .post('/api/Users')
      .set(jsonHeader)
      .send({
  ...
  void it('POST new user with accounting role is downgraded to customer', async () => {
    const res = await request(app)
      .post('/api/Users')
      .set(jsonHeader)
      .send({
  ...
  void it('POST user with arbitrary role is created as customer', async () => {
    const res = await request(app)
      .post('/api/Users')
      .set(jsonHeader)
      .send({
