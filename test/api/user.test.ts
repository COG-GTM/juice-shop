...
void describe('/api/Users', () => {
  ...
  void it('POST new user with admin role is forced to customer', async () => {
    const res = await request(app)
      .post('/api/Users')
      .set(jsonHeader)
      .send({
  ...
  void it('POST new user with deluxe role is forced to customer', async () => {
    const res = await request(app)
      .post('/api/Users')
      .set(jsonHeader)
      .send({
  ...
  void it('POST new user with accounting role is forced to customer', async () => {
    const res = await request(app)
      .post('/api/Users')
      .set(jsonHeader)
      .send({
  ...
  void it('POST user with an arbitrary role is forced to customer', async () => {
    const res = await request(app)
      .post('/api/Users')
      .set(jsonHeader)
      .send({
