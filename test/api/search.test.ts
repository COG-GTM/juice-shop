...
void describe('/rest/products/search', () => {
  ...
  void it('GET product search treats a quote-terminating payload as literal search text', async () => {
    const res = await request(app)
  ...
  void it('GET product search does not allow UNION SELECT on the Users table', async () => {
    const res = await request(app)
  ...
  void it('GET product search does not allow UNION SELECT on the sqlite_master table', async () => {
    const res = await request(app)
