...
void describe('/rest/products/search', () => {
  ...
  void it('GET product search treats SQL syntax as a literal search string', async () => {
    const res = await request(app)
  ...
  void it('GET product search treats an incomplete UNION payload as a literal search string', async () => {
    const res = await request(app)
  ...
  void it('GET product search treats a UNION payload with one closing parenthesis as a literal search string', async () => {
    const res = await request(app)
      .get("/rest/products/search?q=') union select id,email,password from users--")
    assert.equal(res.status, 200)
    assert.ok(res.headers['content-type']?.includes('application/json'))
  ...
  void it('GET product search treats a SELECT * payload as a literal search string', async () => {
    const res = await request(app)
  ...
  void it('GET product search does not expose user credentials through UNION SELECT', async () => {
    const res = await request(app)
  ...
  void it('GET product search does not expose sqlite_master schema through UNION SELECT', async () => {
    const res = await request(app)
  ...
  void it('GET product search does not return logically deleted christmas special for an injection payload', async () => {
    const res = await request(app)
  ...
  void it('GET product search does not return logically deleted unsafe product for an injection payload', async () => {
    const res = await request(app)
