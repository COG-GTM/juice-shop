...
void describe('/rest/products/search', () => {
  ...
  void it('GET product search treats quote characters as literal search text', async () => {
    const res = await request(app)
  ...
  void it('GET product search does not execute UNION SELECT on the Users table', async () => {
    const res = await request(app)
  ...
  void it('GET product search does not execute UNION SELECT on the sqlite_master table', async () => {
    const res = await request(app)
