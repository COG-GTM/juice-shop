...
void describe('/rest/products/search', () => {
  ...
  void it('GET product search treats quote payloads as literal search terms', async () => {
    const res = await request(app)
  ...
  void it('GET product search does not leak users via UNION SELECT', async () => {
    const res = await request(app)
  ...
  void it('GET product search does not leak the database schema via UNION SELECT', async () => {
    const res = await request(app)
