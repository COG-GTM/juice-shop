...
async function findAuthenticatedUser (email: unknown, password: unknown) {
  ...
  if (security.isLegacyPasswordHash(user.password)) {
...
export function login () {
  ...
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    findAuthenticatedUser(req.body.email || '', req.body.password || '') // vuln-code-snippet vuln-line loginAdminChallenge loginBenderChallenge loginJimChallenge
