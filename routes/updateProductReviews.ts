...
export function updateProductReviews () {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    if (typeof req.body.id !== 'string' || typeof req.body.message !== 'string' || !user?.data.email) { // vuln-code-snippet hide-line
      res.status(400).send() // vuln-code-snippet hide-line
