...
describe('AdministrationComponent', () => {
    ...
    it('should determine an active session from the six hour login window', () => {
        ...
        expect(component.doesUserHaveAnActiveSession({ email: 'User', lastLoginTime: nowInSeconds - (sixHoursInSeconds - 60) })).toBe(true)
        expect(component.doesUserHaveAnActiveSession({ email: 'User', lastLoginTime: nowInSeconds - (sixHoursInSeconds + 60) })).toBe(false)
